...
('00000000-0000-0000-0000-000000000005', 'Requiere actualización', 'Requiere actualización', 'Requiere actualización', false, '20000004', false, null, 'https://example.com/images/requiere_actualizacion.jpg');
...
('00000000-0000-0000-0000-000000000003', 150, 0.21, 1.59, 1.0,true, '00000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001');
...
('00000000-0000-0000-0000-000000000003', 'Edificio C, Planta Baja', 'Máquina 3', 1, 1, '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000004', 'Edificio D, Planta Alta', 'Máquina 4', 1, 1, '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000005', 'Edificio E, Planta Baja', 'Máquina 5', 1, 1, '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000006', 'Edificio F, Planta Alta', 'Máquina 6', 1, 1, '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000007', 'Edificio G, Planta Alta', 'Máquina 7', 1, 1, '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000008', 'Edificio H, Planta Alta', 'Máquina 8', 1, 1, '00000000-0000-0000-0000-000000000001');
...
('00000000-0000-0000-0000-000000000002', 3, 0, true, 1, 1, '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000003', 5, 4, false, 1, 1, '00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000004', 4, 2, true, 1, 1, '00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000005', 6, 0, false, 1, 1, '00000000-0000-0000-0000-000000000005', null),
('00000000-0000-0000-0000-000000000006', 6, 2, true, 1, 1, '00000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000007', 6, 1, false, 1, 1, '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000001'),
('00000000-0000-0000-0000-000000000008', 6, 1, false, 1, 1, '00000000-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000005');

INSERT INTO expiration_batch (id, expiration_date,quantity,vending_slot_id) VALUES
('00000000-0000-0000-0000-000000000001', '2024-12-31',2, '00000000-0000-0000-0000-000000000004'),
('00000000-0000-0000-0000-000000000002', '2050-11-30',2, '00000000-0000-0000-0000-000000000003'),
('00000000-0000-0000-0000-000000000003', '2050-11-30',2, '00000000-0000-0000-0000-000000000006'),
('00000000-0000-0000-0000-000000000004', '2050-11-30',1, '00000000-0000-0000-0000-000000000007'),
('00000000-0000-0000-0000-000000000005', '2050-12-31',1, '00000000-0000-0000-0000-000000000008');
