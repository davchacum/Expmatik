...
public class SaleIntegrationTest {
    ...
    @Nested
    @DisplayName("POST /api/sales/real-time")
    class CreateRealTimeSale {

        @Nested
        @DisplayName("Success Sale Cases")
        class SuccessSaleCases {
        ...
        class FailureCases {
            ...
            public void testDecrementVendingSlotStock_ProductNotAssigned_ShouldReturn409() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders.post("/api/sales/real-time")
                    ...
                    .andExpect(jsonPath("$.message").value("Cannot register sale because there is no product assigned to the vending slot."));
            }
            ...
            public void testDecrementVendingSlotStock_ProductInfoNeedUpdate_ShouldReturn409() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders.post("/api/sales/real-time")
                    ...
                    .content(objectMapper.writeValueAsString(saleCreate)))
                    .andExpect(status().isConflict())
                    .andExpect(jsonPath("$.message").value("Cannot register sale because the product info needs to be updated."));
            }
        }
    }
    ...
    @Nested
    @DisplayName("POST /api/sales/csv")
    ...
    @Nested
    @DisplayName("GET /api/sales/csv-export")
    class ExportSalesToCSV {
