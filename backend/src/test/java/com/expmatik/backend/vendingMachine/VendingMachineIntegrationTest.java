...
public class VendingMachineIntegrationTest {
    ...
    @Nested
    @DisplayName("Get /api/vending-machines/{id}")
    ...
    @Nested
    @DisplayName("Get /api/vending-machines")
    class GetAllVendingMachines {
    ...
    @Nested
    @DisplayName("Post /api/vending-machines")
    ...
    @Nested
    @DisplayName("Put /api/vending-machines/{id}")
    class UpdateVendingMachine {
        ...
        class FailureCases {
            ...
            @Test
            @WithUserDetails("admin2@expmatik.com")
            void testUpdateVendingMachine_VendingMachineDoesNotExist_shouldReturn404() throws Exception {
                UUID vendingMachineId = UUID.fromString("00000000-0000-0000-0000-000000000099");
