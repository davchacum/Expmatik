...
public class VendingSlotIntegrationTest {
    ...
    @Nested
    @DisplayName("GET /api/vending-slots/{id}")
    ...
    @Nested
    @DisplayName("PATCH /api/vending-slots/{id}/assign-or-unassign-product")
    class PatchAssignOrUnassignProduct {
        ...
        class FailureCases {
                ...
                public void testAssignProduct_SlotNotEmpty_ShouldReturn409() throws Exception {
                        ...
                        mockMvc.perform(patch("/api/vending-slots/{id}/assign-or-unassign-product", vendingSlotId)
                                        .param("barcode", "20000001"))
                                .andExpect(status().isConflict())
                                .andExpect(jsonPath("$.message").value("The vending slot is not empty."));
                }
    ...
    @Nested
    @DisplayName("PATCH /api/vending-slots/{id}/block-or-unblock")
    class PatchBlockOrUnblock {
        ...
        class FailureCases {
                ...
                public void testUnblockVendingSlot_ExpiredProducts_ShouldReturn409() throws Exception {
                        ...
                        mockMvc.perform(patch("/api/vending-slots/{id}/block-or-unblock", vendingSlotId)
                                        .param("blocked", "false"))
                                .andExpect(status().isConflict())
                                .andExpect(jsonPath("$.message").value("Cannot unblock a vending slot with expired products."));
                }
        }
    }
    ...
    @Nested
    @DisplayName("PATCH /api/vending-slots/{id}/decrement-stock")
    class PatchDecrementStock {
        ...
        class FailureCases {
                ...
                public void testDecrementVendingSlotStock_DecrementingBelowZero_ShouldReturn409() throws Exception {
                        ...
                        mockMvc.perform(patch("/api/vending-slots/{id}/decrement-stock", vendingSlotId))
                                .andExpect(status().isConflict())
                                .andExpect(jsonPath("$.message").value("Cannot remove stock from the vending slot because it is empty."));
                }
                ...
                public void testDecrementVendingSlotStock_ProductNotAssigned_ShouldReturn409() throws Exception {
                        ...
                        mockMvc.perform(patch("/api/vending-slots/{id}/decrement-stock", vendingSlotId))
                                .andExpect(status().isConflict())
                                .andExpect(jsonPath("$.message").value("Cannot register sale because the vending slot does not have a product assigned."));
                }
                ...
                public void testDecrementVendingSlotStock_ExpiredProducts_ShouldReturn409() throws Exception {
                        ...
                        mockMvc.perform(patch("/api/vending-slots/{id}/decrement-stock", vendingSlotId))
                                .andExpect(status().isConflict())
                                .andExpect(jsonPath("$.message").value("Cannot register sale because the product is expired."));
                }
        }
}       
    ...
    @Nested
    @DisplayName("GET /api/vending-slots/{vendingSlotId}/expiration-batches")
    class GetVendingSlotExpirationBatches {
